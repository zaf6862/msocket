            ...
            if(is != null) {
                ...
                while(numRead >= 0) {
                    ...
                    try {
                        ...
                        System.out.println("MSocket read from the client time is: " + read_time_elapsed/1000000.0 + " ms");
                    ...
                    if (numRead > 0) {
                        ...
                        try {
                            ...
                            System.out.println("MSocket Time to write to the socket is: " + write_time_elapsed/1000000.0   + " ms");
                        ...
                        System.out.println("[" + dtf.format(now) + "] Data sending finished. App level transfer time " + elapsed/1000000  + " ms");
                    }
                    run_number += 1;
                }
