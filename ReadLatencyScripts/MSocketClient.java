    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (rd < numRound) {
                ...
                System.out.println("[Write:] " + write_time_elapsed / 1000000.0 + " ms");
                ...
                System.out.println("[Read:] " + read_time_elapsed / 1000000.0  + " ms");
                long app_level_elapsed = System.nanoTime() - app_level_start;



                System.out.println("[TransferTime:] " + app_level_elapsed / 1000000.0 + " ms");

                double n_bytes = numOfBytes;
                n_bytes = n_bytes/1000000;
                double app_level_elap = app_level_elapsed;
                app_level_elap = app_level_elap / 1000000000;
            ...
            os.write(-1);
            os.flush();
//            System.out.println(MSocketInstrumenter.showStats());
            ms.close();
