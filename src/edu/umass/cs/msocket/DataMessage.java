...
public class DataMessage
{
   ...
   * DataMessage.
   */
  //TAG: changed the datamessage structure to store "msg" as an arraylist of bytebuffers
  ...
  /**
   *
   * @return Arraylist of bytebuffers. First element is the header in this list and
   * the rest of the elements are actual data buffers. Don't need to worry about arraycopyoffset
   * because it is always either 0 or -1. 0 means we need all the data buffers. -1 means "msg" is none
   * we don't return any databuffers, just the header bytebuffer.
   */
