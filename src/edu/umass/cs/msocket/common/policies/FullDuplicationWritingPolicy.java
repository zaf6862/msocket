	      ...
	      if( (sockObj1 != null) && (remainingPath1>0) )
	      {
		        ...
		        try
		        {
		          // System.arraycopy(b, offset + currpos, buf, 0, tobesent);
                    ...
                    ByteBuffer bytebuff = ByteBuffer.wrap(b,offset+currposPath1,tobesent);
                    ArrayList<ByteBuffer> bytebuff_list = new ArrayList<ByteBuffer>();
                    bytebuff_list.add(bytebuff);
                    DataMessage dm = new DataMessage(MesgType, tempDataSendSeqNumPath1, cinfo.getDataAckSeq(), tobesent, 0, bytebuff_list,
                            arrayCopyOffset);
		          ...
		          // received data
		            ...
		            {
		              cinfo.attemptSocketWriteOptimized(sockObj1);
...
//		          byte[] writebuf = dm.getBytes();
                    ...
                    int arrayCopyOffset = offset + length - currposPath2 - tobesent;
                    ByteBuffer bytebuff = ByteBuffer.wrap(b,arrayCopyOffset,tobesent);
                    ArrayList<ByteBuffer> bytebuff_list = new ArrayList<ByteBuffer>();
                    bytebuff_list.add(bytebuff);
                    DataMessage dm = new DataMessage(MesgType, tempDataSendSeqNumPath2-tobesent, cinfo.getDataAckSeq(), tobesent, 0, bytebuff_list,
                            arrayCopyOffset);
                    ArrayList<ByteBuffer> writebuf = dm.getBytes();
		          ...
		          // received data
		            ...
		            {
		              cinfo.attemptSocketWriteOptimized(sockObj2);
